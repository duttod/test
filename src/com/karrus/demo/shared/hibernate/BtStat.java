...
/**
 * BtStat generated by hbm2java
 */
public class BtStat implements java.io.Serializable {
	...
	public BtStat(BtStatId id, int sampleSize, int sampleSize5Min, int minTravelTime, int maxTravelTime, int average,
			float standardDeviation, int decile10, int decile20, int decile30, int decile40, int median, int decile60,
			int decile70, int decile80, int decile90) {
		this.id = id;
	...
	public BtStatId getId() {
		return this.id;
	}

	public void setId(BtStatId id) {
		this.id = id;
	}
