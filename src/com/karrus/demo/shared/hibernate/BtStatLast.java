...
/**
 * BtStatLast generated by hbm2java
 */
public class BtStatLast implements java.io.Serializable {

	private BtStatLastId id;
	...
	public BtStatLast(BtStatLastId id, int sampleSize, int sampleSize5Min, int minTravelTime, int maxTravelTime,
	...
	public BtStatLastId getId() {
		return this.id;
	}

	public void setId(BtStatLastId id) {
		this.id = id;
	}
